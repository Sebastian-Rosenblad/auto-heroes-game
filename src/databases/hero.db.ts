export const hero_db: Array<string> = [
  ...
  "Mule;c;1;2;Level up:Double the mule's health.;Dismiss:For each 9 health the mule has, give each other hero 1 health.",
  ...
  "Rat;c;1;1;Start of battle:Summon a Poisonous Rat in front of the Rat.",
