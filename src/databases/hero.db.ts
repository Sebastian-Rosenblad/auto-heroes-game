export const hero_db: Array<string> = [
  ...
  "Rat;c;1;1;Start of battle:Summon a Poisonous Rat with poisonous, same attack as the rat, and half health, in front of the Rat.",
  ...
  "Spider egg;u;0;1;Knocked out:Summon [LEVEL] Spiderling[PLURAL¨¨s].",
  "Berserker;u;1;5;:Whenever the berserker takes damage it gains +[LEVEL] attack.",
  "Cat;u;1;1;:Lifesteal.",
  "Necromancer;u;2;2;:When a non-undead hero is knocked out in front of the necromancer, summon a Risen Skeleton with +[LEVEL*1/3]% of its attack and 1 health in front of the necromancer.",
